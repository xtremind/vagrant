...
sudo DEBIAN_FRONTEND=noninteractive apt-get install -y xfce4 xfce4-whiskermenu-plugin
...
sudo sed -i 's/XSession\=.*/XSession\=xfce/g' /var/lib/AccountsService/users/ubuntu
